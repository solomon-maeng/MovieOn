package com.remember.playground.mockk

import com.remember.playground.mockk.Bar.bar
...
@Ignored
class StudyMockKSpec : StringSpec() {
    ...
    init {
        ...
        "최상위 확장 함수를 스텁할 수 있다" {
            mockkStatic("com.remember.playground.mockk.StudyMockKSpecKt")
            every { "first".baz("second") } answers {
                firstArg<String>() shouldBe "first"
                secondArg<String>() shouldBe "second"
            }
            "first".baz("second")
            unmockkStatic("com.remember.playground.mockk.StudyMockKSpecKt")
        }
