...
interface UserApiSpecification {
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "200", description = "회원가입 성공"),
            ApiResponse(responseCode = "400", description = "회원가입 요청 파라미터 에러", content = [Content()])]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "303", description = "회원가입 처리 완료 및 리다이렉트"),
            ApiResponse(responseCode = "400", description = "회원가입 확인 파라미터 에러", content = [Content()])]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "200", description = "로그인 성공"),
            ApiResponse(responseCode = "400", description = "로그인 요청 파라미터 에러", content = [Content()])]
    )
    ...
    @ApiResponses(
        value = [ApiResponse(responseCode = "200", description = "토큰 재발급 성공"),
            ApiResponse(responseCode = "400", description = "토큰 재발급 요청 에러", content = [Content()])]
    )
